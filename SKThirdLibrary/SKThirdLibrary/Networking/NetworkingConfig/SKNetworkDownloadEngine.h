...
/* =============================
 *
 * SKNetworkDownloadEngine
 *
 * SKNetworkDownloadEngine is in charge of sending downloading requests.
 *
 * =============================
 */

@interface SKNetworkDownloadEngine : SKNetworkBaseEngine
