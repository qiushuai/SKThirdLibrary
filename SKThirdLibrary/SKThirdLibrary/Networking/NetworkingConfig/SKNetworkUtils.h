 ...
 * SKNetworkUtils
 *
 * SKNetworkUtils is in charge of some operation of string or generate information
 *
 * =============================
 */

extern NSString * _Nonnull const SKNetworkCacheBaseFolderName;
extern NSString * _Nonnull const SKNetworkCacheFileSuffix;
extern NSString * _Nonnull const SKNetworkCacheInfoFileSuffix;
extern NSString * _Nonnull const SKNetworkDownloadResumeDataInfoFileSuffix;

@interface SKNetworkUtils : NSObject
