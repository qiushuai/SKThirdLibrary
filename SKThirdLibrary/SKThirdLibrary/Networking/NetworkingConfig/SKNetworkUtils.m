...
NSString * const SKNetworkCacheBaseFolderName = @"SKNetworkCache";
NSString * const SKNetworkCacheFileSuffix = @"cacheData";
NSString * const SKNetworkCacheInfoFileSuffix = @"cacheInfo";
NSString * const SKNetworkDownloadResumeDataInfoFileSuffix = @"resumeInfo";

@implementation SKNetworkUtils
...
+ (NSString * _Nonnull)generateRequestIdentiferWithBaseUrlStr:(NSString * _Nullable)baseUrlStr
    ...
    //    SKNetworkLog(@"请求接口：%@%@%@", baseUrlStr,requestUrlStr,paramsStr);
...
+ (NSString * _Nonnull)createCacheBasePath{
    ...
    return [self createBasePathWithFolderName:SKNetworkCacheBaseFolderName];
}
...
+ (NSString * _Nonnull)cacheDataFilePathWithRequestIdentifer:(NSString * _Nonnull)requestIdentifer{
    ...
    if (requestIdentifer.length > 0) {
        ...
        NSString *cacheFileName = [NSString stringWithFormat:@"%@.%@", requestIdentifer,SKNetworkCacheFileSuffix];
...
+ (NSString * _Nonnull)cacheDataInfoFilePathWithRequestIdentifer:(NSString * _Nonnull)requestIdentifer{
    ...
    if (requestIdentifer.length > 0) {
        ...
        NSString *cacheInfoFileName = [NSString stringWithFormat:@"%@.%@", requestIdentifer,SKNetworkCacheInfoFileSuffix];
...
+ (NSString * _Nonnull)resumeDataInfoFilePathWithRequestIdentifer:(NSString * _Nonnull)requestIdentifer{
    ...
    NSString * dataInfoFileName = [NSString stringWithFormat:@"%@.%@", requestIdentifer,SKNetworkDownloadResumeDataInfoFileSuffix];
