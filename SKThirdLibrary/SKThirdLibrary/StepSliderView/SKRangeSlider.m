 ...
 */
@interface SKRangeSliderLeftElement : UIAccessibilityElement
@end

/**
 An accessibility element that increments and decrements the right slider
 */
@interface SKRangeSliderRightElement : UIAccessibilityElement
@end
...
- (void)initialiseControl {
    ...
    self.sliderLine.backgroundColor = [UIColor colorWithRed:245/255.0 green:245/255.0 blue:245/255.0 alpha:1.0].CGColor;
    ...
    self.sliderLineBetweenHandles.backgroundColor = [UIColor colorWithRed:245/255.0 green:245/255.0 blue:245/255.0 alpha:1.0].CGColor;
...
{
    SKRangeSliderLeftElement *element = [[SKRangeSliderLeftElement alloc] initWithAccessibilityContainer:self];
...
{
    SKRangeSliderRightElement *element = [[SKRangeSliderRightElement alloc] initWithAccessibilityContainer:self];
    element.isAccessibilityElement = YES;
...
@implementation SKRangeSliderLeftElement

- (void)accessibilityIncrement {
    SKRangeSlider* slider = (SKRangeSlider*)self.accessibilityContainer;
...
@implementation SKRangeSliderRightElement
