...
/*
 借鉴TTRangeSlider，如果想用TTRangeSlider的，传送门：https://github.com/TomThorpe/TTRangeSlider，用法与之一样
 */

#import <UIKit/UIKit.h>
#import "SKRangeSliderDelegate.h"
NS_ASSUME_NONNULL_BEGIN

@interface SKRangeSlider : UIControl<UIGestureRecognizerDelegate>
/**
 * Optional delegate.
 */
@property (nonatomic, weak) IBOutlet id<SKRangeSliderDelegate> delegate;
