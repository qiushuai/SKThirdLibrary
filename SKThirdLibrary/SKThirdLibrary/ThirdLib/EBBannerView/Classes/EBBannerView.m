...
-(void)tapGesture:(UITapGestureRecognizer*)tapGesture{
    if (_maker.showDetailOrHideWhenClickLongText && !self.lineView.hidden) {
        ...
        NSDictionary *dict =[[NSDictionary alloc]initWithObjectsAndKeys:_maker.myId,@"id",_maker.messageType,@"messageType",nil];
        [KNotificationCenter postNotificationName:EBBannerViewDidClickNotification object:nil userInfo:dict];
        [self hide];
    }
}
