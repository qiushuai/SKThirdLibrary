...
/** 滚动条距离底部的高度 默认为0 */
@property (assign, nonatomic) CGFloat lineBottomHeight;
/** 滚动条的颜色 */
...
/** 是否显示自定义滚动条 默认为NO */
@property (assign, nonatomic, getter=isShowCustomLine) BOOL showCustomLine;
/** 自定义滚动条 */
@property (strong, nonatomic) UIImage *customLine;
