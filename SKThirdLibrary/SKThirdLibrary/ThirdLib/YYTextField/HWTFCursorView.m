...
{
    self.backgroundColor = KRGB16HEX(0xF5F5F5);
    ...
    textField.tintColor = KRGB16HEX(0x232824);
    ...
    maskView.backgroundColor = KRGB16HEX(0xF5F5F5);
    ...
    for (NSInteger i = 0; i < self.itemCount; i++)
    {
        ...
        line.backgroundColor = KRGB16HEX(0xE0E0E0);
...
- (void)setupView
{
    ...
    cursorView.backgroundColor = KRGB16HEX(0x232824);
    cursorView.alpha = 0;
