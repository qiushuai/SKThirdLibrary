                             ...
                             succes:^(NSDictionary *appStoreDictionary)
     {
         ...
         if(versionStatus == 1)
         {
             switch (self.promptType) {
                 ...
                 {
                     BOOL isCancel = NO;
                     if ([[[self getVersionParams] allKeys] containsObject:@"isCancelPrompt"]) {
                 ...
                 case WYVersionPromptCycle:
                 {
                     ...
                     if ([[[self getVersionParams] allKeys] containsObject:@"lastTimeInterval"])
                     {
                 ...
                 case WYVersionPromptIgnore:
                 {
                     ...
                     if ([[[self getVersionParams] allKeys] containsObject:@"lastVersion"]) {
