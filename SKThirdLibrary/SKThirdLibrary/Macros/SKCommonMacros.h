...
#ifndef SKCommonMacros_h
#define SKCommonMacros_h
...
/** Block 引用 */
#define SKBlockSelf     __block typeof(self)    blockSelf  =  self;

/** 强引用 */
#define SKStrongSelf    __strong typeof(self)   strongSelf  =  self;
